        ...
        function displayCurrentWeather() {
            ...
            $.ajax({
                ...
                $.ajax({
                    ...
                    let day1TempFah = Math.round((response.list[2].main.temp - 273.15) * 1.8 + 32);
                    ...
                    let day2TempFah = Math.round((response.list[10].main.temp - 273) * 1.8 + 32);
                    ...
                    let day3TempFah = Math.round((response.list[18].main.temp - 273) * 1.8 + 32);
                    ...
                    let currentWeatherIcon4 = "http://openweathermap.org/img/wn/" + day4Icon + "@2x.png"

                    let day4TempFah = Math.round((response.list[26].main.temp - 273) * 1.8 + 32);
                    ...
                    let currentWeatherIcon5 = "http://openweathermap.org/img/wn/" + day5Icon + "@2x.png"

                    let day5TempFah = Math.round((response.list[34].main.temp - 273) * 1.8 + 32);
                ...
                //Creating Buttons from Searchd Locations 
            ...
            $(document).on("click", ".weather-btn", displayCurrentWeather);
        };
    };
});
// $(document).on("click", ".weather-btn", displayCurrentWeather);
